import { BarChart3, Bell, Calendar, CheckSquare, FileText, Globe, Users } from "lucide-react";
	...
	return (
		<div className="min-h-screen bg-background">
			...
			<section className="relative pt-32 pb-24 overflow-hidden" ref={heroRef}>
				...
				<div
					className="absolute bottom-20 right-10 w-80 h-80 bg-blue-500/10 rounded-full filter blur-3xl animate-float opacity-20"
					style={{
						animationDelay: "2s"
					}}></div>
				...
				<div className="container px-4 mx-auto relative z-10">
					<div className="max-w-4xl mx-auto text-center">
						<h1 className="text-5xl md:text-7xl font-bold mb-8 text-gradient leading-loose py-2">
							Construction Management <span className="text-primary">Simplified.</span>
						</h1>
						<p className="text-xl md:text-2xl text-white/80 mb-8 max-w-2xl mx-auto">Streamline your building projects with the ultimate project management app designed specifically for builders.</p>
			...
			<section id="features" className="py-20 relative overflow-hidden">
				<div className="container px-4 mx-auto">
					<div className="text-center max-w-3xl mx-auto mb-16 fade-in">
						<h2 className="text-3xl md:text-4xl font-bold mb-4 text-gradient">Powerful Features for Builders</h2>
						<p className="text-white/70 text-lg">ONEBUILD comes packed with everything you need to manage your construction projects efficiently.</p>
					</div>
			...
			<section id="benefits" className="py-24 relative overflow-hidden">
				...
				<div className="container px-4 mx-auto">
					<div className="text-center max-w-3xl mx-auto mb-16 fade-in">
						<h2 className="text-3xl md:text-4xl font-bold mb-4 text-gradient">Why Builders Choose ONEBUILD</h2>
						<p className="text-white/70 text-lg">Join thousands of builders who are transforming their workflow with our specialized platform.</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8 fade-in">
						<div className="p-6 rounded-xl border border-white/10 bg-black/20 backdrop-blur-sm hover:bg-black/30 transition-all">
							...
							<p className="text-white/70">
								Reduce administrative overhead and stay focused on what matters—building. Our intuitive interface simplifies project management, saving you valuable time.
							</p>
						</div>
						...
						<div className="p-6 rounded-xl border border-white/10 bg-black/20 backdrop-blur-sm hover:bg-black/30 transition-all">
							...
							<p className="text-white/70">Eliminate miscommunications with a centralized platform where all stakeholders can share updates, documents, and feedback in real-time.</p>
						</div>
						...
						<div className="p-6 rounded-xl border border-white/10 bg-black/20 backdrop-blur-sm hover:bg-black/30 transition-all">
							...
							<p className="text-white/70">Keep projects on schedule and on budget with powerful planning tools and analytics that help you identify issues before they become costly problems.</p>
						</div>
					</div>
				...
				<div className="container px-4 mx-auto relative z-10">
					<div className="max-w-4xl mx-auto glass-card p-8 md:p-12 rounded-2xl shadow-2xl border border-white/10 fade-in">
						<p className="text-xl md:text-2xl text-white/90 italic mb-6 leading-relaxed">
							"ONEBUILD has completely transformed how we manage our construction projects. The ability to track tasks, store documents, and communicate with the team all in one place has made our
							workflow incredibly efficient. We've reduced administrative time by almost 40%."
						</p>
			...
			<section className="py-24 relative overflow-hidden">
				<div className="container px-4 mx-auto">
					<div className="max-w-4xl mx-auto text-center mb-12 fade-in">
						...
						<h2 className="text-3xl md:text-4xl font-bold mb-4 text-gradient">Available in Multiple Languages</h2>
						<p className="text-white/70 text-lg">ONEBUILD is designed for an international workforce, with full support for English and Spanish.</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto fade-in">
						<div className="p-8 rounded-xl border border-white/10 bg-black/20 backdrop-blur-sm hover:bg-black/30 transition-all text-center">
							...
							<p className="text-white/70">Every feature, document, and interface element is available in English, making the app accessible to English-speaking teams worldwide.</p>
						</div>

						<div className="p-8 rounded-xl border border-white/10 bg-black/20 backdrop-blur-sm hover:bg-black/30 transition-all text-center">
							<div className="text-3xl font-bold mb-4">🇪🇸 Español</div>
							<p className="text-white/70">Acceda a todas las funciones en español, permitiendo que los equipos de habla hispana aprovechen al máximo la aplicación sin barreras lingüísticas.</p>
						</div>
					</div>

					<div className="text-center mt-12 fade-in">
						<p className="text-white/70">
							Our commitment to language accessibility ensures that construction teams can collaborate effectively regardless of their primary language. Additional language support coming soon.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="py-24 relative bg-gradient-to-b from-background to-black">
				<div className="container px-4 mx-auto">
					<div className="text-center max-w-3xl mx-auto fade-in">
						<h2 className="text-3xl md:text-5xl font-bold mb-6 text-gradient">Ready to Transform Your Building Process?</h2>
						<p className="text-xl text-white/70 mb-8">Join thousands of builders who have streamlined their workflow with ONEBUILD.</p>
