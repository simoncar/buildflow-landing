  ...
  return <section id="app" className="py-24 overflow-hidden relative">
			...
			<div className="container px-4 mx-auto">
				<div className="text-center max-w-3xl mx-auto mb-16">
					<h2 className="text-3xl md:text-4xl font-bold mb-4 text-gradient">Powerful Mobile Experience</h2>
					<p className="text-white/70 text-lg">ONEBUILD brings professional construction project management to your fingertips with an intuitive interface designed specifically for builders.</p>
				</div>
				...
				<div className="relative">
					...
					<div className="flex justify-center items-center mt-8 space-x-4">
						<button onClick={prevSlide} className="p-2 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 transition-colors" aria-label="Previous screenshot">
