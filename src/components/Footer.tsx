      ...
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="space-y-4">
            ...
            <p className="text-sm text-white/60">
              Project management solution designed specifically for builders and construction professionals.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-sm text-white/60 hover:text-white transition-colors">About Us</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#" className="text-sm text-white/60 hover:text-white transition-colors">Tutorials</a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-white/40">
            © {new Date().getFullYear()} ONEBUILD. All rights reserved.
          </p>
